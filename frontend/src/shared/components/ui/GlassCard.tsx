...
const GlassCard: React.FC<GlassCardProps> = ({ children, className = '' }) => (
  <motion.div
    ...
    className={`relative w-full max-w-full md:max-w-md rounded-2xl md:rounded-3xl border border-white/10 bg-slate-900/40 backdrop-blur-xl shadow-[0_0_60px_rgba(15,23,42,0.6)] overflow-hidden ${className}`}
  >
    {/* Border glow effect */}
